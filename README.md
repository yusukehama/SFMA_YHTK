...
### 3. Files of W matrices
1. C6_6x2.pickle.bz2: - The data file of the W matrices with the number of spins (qubits) equal to 12 (n_bit = 12). 
                     
2. C6_8x2.pickle.bz2: - The data file of the W matrices with n_bit = 16.

3. C6_10x2.pickle.bz2: - The data file of the W matrices with n_bit = 20.

These data files can be generated using files "z000.ipynb" and "mid.py", which can be obtained from Supplementary Information 2 and Supplementary Information 3, respectively, in Ref. [86] (DOI: https://doi.org/10.1038/s41598-022-19763-8). According to the restrictions of the applied licenses, these files are not redistributed in this repository. The data files are created by chainging the set of parameters (N, D, K) in "z000.ipynb" from (8, 100, 3) to (6, 50, 2), (8, 50, 2), and (10, 50, 2) for n_bit = 12,16, and 20, respectively. In addition, the original data of the W matrices, the model parameters of the final fully connected layer of VGG16 convolutional neural network (Ref. [109]), is necessary. The data file of the model parameters used in this research was obtained externally and is not redistributed in this repository. Please download them using standard libraries such as torchvision.    

### 4. Files for Verifying the Validity of SA and QA 
...
### 5. Files for Generating Initial Datasets 
...
### 6. Files for Executing SFMA and FMA
...
### 7. Directories Containing Save the Inital Datasets and the Results
...
### 8. Files for Displaying the Results
